...
class AbuseIPDBConnector:
    ...
    def _process_message(self, data):
        ...
        params = {"maxAgeInDays": 30, "verbose": "True", "ipAddress": observable_value}
        ...
        self.helper.api.stix_cyber_observable.update_field(
            ...
            {
                "key": "x_opencti_abuseipdb_confidence",
                "value": str(data["abuseConfidenceScore"]),
            },
            {
                "key": "x_opencti_abuseipdb_country", 
                "value": str(data["countryCode"])
            },
            {
                "key": "x_opencti_abuseipdb_isp", 
                "value": str(data["isp"])
            },
            ]
        )
